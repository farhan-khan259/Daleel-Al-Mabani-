const translations = {
  ar: {
    ...
    'faq.q1': 'هل تتم مراجعة المشاريع وفق الكود السعودي؟',
    'faq.a1': 'نعم، نقوم بمراجعة جميع الحلول والتصاميم وفق الاشتراطات السعودية واللوائح المعمول بها.',
    'faq.q2': 'هل يمكنكم متابعة التراخيص والاعتمادات؟',
    'faq.a2': 'بالتأكيد، نتابع كافة الإجراءات مع الدفاع المدني والجهات المختصة حتى الحصول على الاعتماد النهائي.',
    'faq.q3': 'هل تعملون على المشاريع الصغيرة والكبيرة؟',
    'faq.a3': 'نعم، نعمل على المشاريع السكنية والتجارية والمجمعات الصناعية والجهات الحكومية بنفس الدرجة من الاهتمام.',
  ...
  en: {
    ...
    'faq.q1': 'Are projects reviewed in line with the Saudi code?',
    'faq.a1': 'Yes. We review all solutions and designs according to Saudi requirements and applicable regulations.',
    'faq.q2': 'Can you manage licensing and approvals?',
    'faq.a2': 'Absolutely. We handle the full process with civil defense and the relevant authorities until final approval is obtained.',
    'faq.q3': 'Do you work on small and large projects?',
    'faq.a3': 'Yes. We work on residential, commercial, industrial, and government projects with the same level of attention.',
